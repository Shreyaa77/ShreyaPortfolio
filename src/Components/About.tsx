    ...
    <>
      ...
      <section id="About" className="about-body">
        ...
        <p className="me">
          ...
          computer systems. Currently, as I pursue my Master’s, I spend my time
          researching, designing, prototyping, and coding. When I'm not
          studying, I enjoy curling up with a good book or sketching and
